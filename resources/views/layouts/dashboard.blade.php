...
<div class="min-h-full">
    ...
    <nav class="bg-gray-800">
            ...
            <div class="flex h-16 items-center justify-between">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <img src="{{ asset('storage/logo/logo-transparent.png') }}" style="width: 4rem" alt="Abou Arab">
                    </div>
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flex w-full flex-wrap mb-8 justify-between">
                <div class="col"><h1 class="text-3xl font-bold tracking-tight text-gray-900">{{ $title ?? 'Dashboard' }}</h1></div>
                <div class="col">@yield('header-buttons')</div>
            </div>
        </header>
