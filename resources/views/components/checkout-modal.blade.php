                                                ...
                                                <div class="col-span-2 md:col-span-3">
                                                    ...
                                                    <div class="mt-2">
                                                        <select id="region" name="region" autocomplete="region-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6">
                                                            <option value="1" @if(optional($address)->region === 'Al-Hadath') selected @endif>Al-Hadath</option>
                                                            <option value="2" @if(optional($address)->region === 'Sad Al Bouchrieh') selected @endif>Sad Al Bouchrieh</option>
                                                            <option value="3" @if(optional($address)->region === 'Al-Mansouriey') selected @endif>Al-Mansouriey</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-span-2 md:col-span-3">
